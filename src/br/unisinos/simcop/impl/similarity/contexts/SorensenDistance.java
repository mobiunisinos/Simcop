...
/**
 * Implements the Soresen Distance aka Bray-Curtis Distance.<br/>
 *
 * @author tiago
 * @see br.unisinos.simcop.core.CommonFunctions#sorensenSimilarity(double[], double[])
 */
public class SorensenDistance extends ContextSimilarity {
    ...
    protected double internalGetSimilarity(Context c1, Context c2) throws Exception {
        ...
        if (map != null && map.size() > 0) {
            ...
            return CommonFunctions.sorensenDistance(P, Q);
        } else {
            return 0;
        }
    }
