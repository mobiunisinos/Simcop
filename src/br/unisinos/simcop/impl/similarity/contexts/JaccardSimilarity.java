...
/**
 * Implements the Jaccard Distance .<br/>
 *
 *
 * @author tiago
 * @see br.unisinos.simcop.core.CommonFunctions#jaccardDistance(double[], double[])
 */
public class JaccardSimilarity extends ContextSimilarity {
    ...
    protected double internalGetSimilarity(Context c1, Context c2) throws Exception {
        ...
        if (map != null && map.size() > 0) {
            ...
            return CommonFunctions.jaccardSimilarity(P, Q);
        } else {
            return 0;
        }
    }
